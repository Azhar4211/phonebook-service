...
public class UserServiceImpl {
    ...
    public List<UserData> getAllUsers() {
        UserData userData = new UserData(1,"Azhar", "Ali", "john.doe@example.com", "Streat   asas","Lahore","Pakistan","03424341036","Test Addreess","123456",0);
        UserData userData2 = new UserData(2, "Tayyab", "Maqsood", "john22.doe@example.com", "Awan Town","Kashmir","India","0363602222","Test 22222","123456",0);
